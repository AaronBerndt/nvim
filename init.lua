...
require("lazy").setup({
  "folke/which-key.nvim",
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>op", ":Octo pr list labels=Virtual\\ Care<CR>", {})
      vim.keymap.set("n", "<leader>os", ":Octo review start<CR>", {})
    end,
  },
  {
    "folke/snacks.nvim",
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap("n", "<leader>m", ":lua OpenFileInVsplitNoice()<CR>", { noremap = true, silent = true })
    end,
  },
